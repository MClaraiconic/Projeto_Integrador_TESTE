...
<main>
    ...
    function adicionarProduto() {
        ...
        // Limpa a seleção do clone para o novo item vir em branco
    ...
    <section>
        ...
        <div class="tabela-produtos">
            <?php
            // SOLUÇÃO DEFINITIVA: Usamos p.id_cliente (que existe na tabela pedido) e apelidamos de 'id_do_cliente'
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo " <td>" . $row['id_do_cliente'] . "</td>"; // Exibe o ID real dele vindo do banco (Ex: 1)
                echo " <td>" . $row['nome_cliente'] . "</td>";  // Exibe o nome associado (Ex: Alice)
                echo " <td>" . $row['status_entrega'] . "</td>";
                echo " <td>" . $row['endereco_pedido'] . "</td>";
                echo " </tr>";
            }
            echo "</table>";
            ?>
